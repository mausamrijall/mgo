...
const (
	GreeterService_Greet_FullMethodName = "/greeter.v1.GreeterService/Greet"
)
...
//
// GreeterService is the extracted service boundary. The Go interface it
// mirrors (main.Greeter) existed before the wire did — extraction, not
// rewrite.
